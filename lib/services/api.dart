import 'dart:convert';
import 'package:election_exit_poll_620710728/models/api_result.dart';
...
class Api {
  ...
  Future<dynamic> submit(
    ...
    final response = await http.post(
      url,
      headers: {'Content-Type': 'application/json','id':'620710728'},
  ...
  Future<dynamic> fetch(
    ...
    final response = await http.get(url,headers: {'id' : '620710728'});
